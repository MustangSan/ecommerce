					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>Pick</span> a Shoe</h1>
									<h2>Sapato com Velcro</h2>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
									<button type="button" class="btn btn-default get">Comprar agora</button>
								</div>
								<div class="col-sm-6">
									<img src="../../assets/images/home/velcro.jpg" class="girl img-responsive" alt="" />
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>Pick</span> a Shoe</h1>
									<h2>Sapato com Cadarço</h2>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
									<button type="button" class="btn btn-default get">Comprar agora</button>
								</div>
								<div class="col-sm-6">
									<img src="../../assets/images/home/cadarco.jpg" class="girl img-responsive" alt="" />
									<img src="../../assets/images/home/pricing.png"  class="pricing" alt="" />
								</div>
							</div>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>Pick</span> a Shoe</h1>
									<h2>Sapato com Fivela</h2>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
									<button type="button" class="btn btn-default get">Comprar agora</button>
								</div>
								<div class="col-sm-6">
									<img src="../../assets/images/home/fivela.jpg" class="girl img-responsive" alt="" />
									<img src="../../assets/images/home/pricing.png" class="pricing" alt="" />
								</div>
							</div>
					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#velcro">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											Sapato com Velcro
										</a>
									</h4>
								</div>
								<div id="velcro" class="panel-collapse collapse">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#cadarco">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											Sapato com Cadarço
										</a>
									</h4>
								</div>
								<div id="cadarco" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="#">Unisex </a></li>
											<li><a href="#">Feminino </a></li>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#vivela">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											Sapato com Fivela
										</a>
									</h4>
								</div>
								<div id="vivela" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="#">Unisex </a></li>
											<li><a href="#">Feminino </a></li>
					...
					<div class="category-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#unisex" data-toggle="tab">Unisex</a></li>
								<li><a href="#feminino" data-toggle="tab">Feminino</a></li>
								<li><a href="#masculino" data-toggle="tab">Masculino</a></li>
							</ul>
						</div>
						<div class="tab-content">
							<div class="tab-pane fade active in" id="unisex" >
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
